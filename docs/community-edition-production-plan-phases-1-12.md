...
1. Normalize runtime observations into evidence, control results, findings, coverage, and explicit inconclusive reasons, preserving fail-closed low-sample and worker-failure behavior.
