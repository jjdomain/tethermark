...
export function buildExecutiveSummaryPayload(args: {
  ...
  return {
    ...
    static_score: args.summary.static_score ?? null,
    methodology_version: args.summary.methodology_version ?? null,
    static_baseline_version: args.summary.static_baseline_version ?? null,
    dimension_scores: args.summary.dimension_scores ?? {},
    assessed_commit: args.summary.assessed_commit ?? null,
